...
const unsigned char FontThick[60][7] = {
    ...
    {0x60, 0x66, 0x66, 0x7f, 0x7f, 0x60, 0x60},
    {0x7b, 0x7b, 0x6b, 0x6b, 0x6b, 0x6f, 0x6f},
    {0x63, 0x63, 0x6b, 0x6b, 0x6b, 0x7f, 0x7f},
    {0x1f, 0x1f, 0x18, 0x18, 0x18, 0x7e, 0x7e},
    {0x6f, 0x6f, 0x6b, 0x6b, 0x6b, 0x7b, 0x7b},
    {0x7f, 0x7f, 0x6c, 0x6c, 0x6c, 0x7c, 0x7c},
    {0x43, 0x63, 0x73, 0x3b, 0x1f, 0x0f, 0x07},
    {0x7f, 0x7f, 0x6b, 0x6b, 0x6b, 0x7f, 0x7f},
    {0x1f, 0x1f, 0x1b, 0x1b, 0x1b, 0x7f, 0x7f},
    ...
    {0x7f, 0x7f, 0x1b, 0x1b, 0x1b, 0x7f, 0x7f},
    {0x7f, 0x7f, 0x6b, 0x6b, 0x6f, 0x7e, 0x7c},
    {0x7f, 0x7f, 0x63, 0x63, 0x63, 0x63, 0x63},
    {0x7f, 0x7f, 0x63, 0x63, 0x67, 0x7e, 0x7c},
    {0x7f, 0x7f, 0x6b, 0x6b, 0x6b, 0x6b, 0x6b},
    {0x7f, 0x7f, 0x0b, 0x0b, 0x0b, 0x03, 0x03},
    {0x7f, 0x7f, 0x63, 0x63, 0x6b, 0x7b, 0x7b},
    {0x7f, 0x7f, 0x18, 0x18, 0x18, 0x7f, 0x7f},
    {0x63, 0x63, 0x7f, 0x7f, 0x63, 0x63, 0x63},
    {0x60, 0x60, 0x60, 0x60, 0x60, 0x7f, 0x3f},
    {0x7f, 0x7f, 0x18, 0x18, 0x1e, 0x7f, 0x79},
    {0x7f, 0x7f, 0x60, 0x60, 0x60, 0x60, 0x60},
    {0x7f, 0x7f, 0x03, 0x06, 0x03, 0x7f, 0x7f},
    {0x7f, 0x7f, 0x0e, 0x1c, 0x38, 0x7f, 0x7f},
    {0x7f, 0x7f, 0x63, 0x63, 0x63, 0x7f, 0x7f},
    {0x7f, 0x7f, 0x1b, 0x1b, 0x1b, 0x1f, 0x1f},
    {0x7f, 0x7f, 0x63, 0xf3, 0xf3, 0x7f, 0x7f},
    {0x7f, 0x7f, 0x1b, 0x3b, 0x7b, 0x7f, 0x5f},
    {0x6f, 0x6f, 0x6b, 0x6b, 0x6b, 0x7b, 0x7b},
    {0x03, 0x03, 0x7f, 0x7f, 0x03, 0x03, 0x03},
    {0x7f, 0x7f, 0x60, 0x60, 0x60, 0x7f, 0x7f},
    {0x1f, 0x3f, 0x70, 0x60, 0x70, 0x3f, 0x1f},
    {0x3f, 0x7f, 0x60, 0x30, 0x60, 0x7f, 0x3f},
    {0x77, 0x7f, 0x1c, 0x08, 0x1c, 0x7f, 0x77},
    {0x07, 0x0f, 0x7c, 0x78, 0x7c, 0x0f, 0x07},
...
void adc_init(void)
{
 ((SYSCTL_Type *) 0x400FE000UL)->RCGCGPIO |= 0x10;
 __asm("NOP");
 __asm("NOP");
 __asm("NOP");
 while (((SYSCTL_Type *) 0x400FE000UL)->PRGPIO == 0);

 ((GPIOA_Type *) 0x40024000UL)->DIR &= 0xFFFFFFF7;
 ((GPIOA_Type *) 0x40024000UL)->AMSEL |= 0x08;
 ((GPIOA_Type *) 0x40024000UL)->AFSEL |= 0x08;

 ((GPIOA_Type *) 0x40024000UL)->DEN |= 0x04;
 ((GPIOA_Type *) 0x40024000UL)->AFSEL &= 0xFFFFFFFB;
 ((GPIOA_Type *) 0x40024000UL)->DIR &= 0xFFFFFFFB;

 ((SYSCTL_Type *) 0x400FE000UL)->RCGCADC |= 0x01;
 __asm("NOP");
 __asm("NOP");
 __asm("NOP");
 while (((SYSCTL_Type *) 0x400FE000UL)->PRADC == 0);

 ((ADC0_Type *) 0x40038000UL)->ACTSS &= 0xFFFFFFF7;
 ((ADC0_Type *) 0x40038000UL)->EMUX &= 0xFFFF0FFF;
 ((ADC0_Type *) 0x40038000UL)->SSCTL3 |= 0x06;
 ((ADC0_Type *) 0x40038000UL)->PC |= 0x01;
 ((ADC0_Type *) 0x40038000UL)->ACTSS |= 0x08;
 ((ADC0_Type *) 0x40038000UL)->PSSI |= 0x08;
 ((ADC0_Type *) 0x40038000UL)->ISC |= 0x08;
}

int data_read(void){
 int temp;
 while (1){
  if (((ADC0_Type *) 0x40038000UL)->RIS & 0x8){
   temp = ((ADC0_Type *) 0x40038000UL)->SSFIFO3;
   ((ADC0_Type *) 0x40038000UL)->ISC |= 0x08;
   ((ADC0_Type *) 0x40038000UL)->PSSI |= 0x08;
   return temp;
  }
...
{
 if (((GPIOA_Type *) 0x40024000UL)->DATA | 0xFFFFFFFB)
 {
  return 1;
 }
 else
